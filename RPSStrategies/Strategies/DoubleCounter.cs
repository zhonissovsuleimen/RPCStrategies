...
{
    internal class DoubleCounter : AbstractStrategy
    {
        ...
        public override void Pick()
        {
            ...
            Hand FirstCounter = GetCounter(OpponentsLastPick);
            Hand OpponentsCounter = GetCounter(FirstCounter);
            Hand = GetCounter(OpponentsCounter);
        }
